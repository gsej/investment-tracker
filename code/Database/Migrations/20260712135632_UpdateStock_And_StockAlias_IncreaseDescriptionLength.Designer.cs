...
namespace Database.Migrations
{
    ...
    [Migration("20260712135632_UpdateStock_And_StockAlias_IncreaseDescriptionLength")]
    partial class UpdateStock_And_StockAlias_IncreaseDescriptionLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Entities.AccountHistoricalValue", b =>
                {
                    b.Property<int>("AccountHistoricalValueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AccountHistoricalValueId"));
                    ...
                    b.Property<decimal?>("RecordedTotalValueInGbp")
                        .HasPrecision(19, 5)
                        .HasColumnType("decimal(19,5)");

                    b.Property<string>("RecordedTotalValueSource")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<int>("TotalPriceAgeInDays")
                        .HasColumnType("int");

                    b.Property<decimal>("ValueInGbp")
                        .HasPrecision(19, 5)
                        .HasColumnType("decimal(19,5)");

                    b.HasKey("AccountHistoricalValueId");

                    b.ToTable("AccountHistoricalValue");
                });
            ...
            modelBuilder.Entity("Database.Entities.CashStatementItem", b =>
                {
                    ...
                    b.Property<decimal?>("DividendQuantity")
                        .HasPrecision(19, 5)
                        .HasColumnType("decimal(19,5)");
            ...
            modelBuilder.Entity("Database.Entities.Comment", b =>
                {
                    ...
                    b.Property<string>("AccountCodes")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
