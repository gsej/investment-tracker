...
public class UnitCalculatorTests
{
    ...
    public void Handle_WhenNoDataExists_ReturnsEmptyItemsForEachDate()
    {
        ...
        {
            new(new DateOnly(2024, 7, 18), 0, 0, 0, "comment"),
            new(new DateOnly(2024, 7, 19), 19000, 19000, 0, "deposit"),
            new(new DateOnly(2024, 7, 20), 19102.52000m, 0, 0, "interest received"),
            new(new DateOnly(2024, 7, 21), 19102.52000m, 0, 0, "nothing"),
            new(new DateOnly(2024, 7, 22), 19102.52000m, 0, 0, "nothing"),
            new(new DateOnly(2024, 7, 23), 20032.94000m, 0, 0, "interest received"),
            new(new DateOnly(2024, 7, 24), 0, -20032.94000m, 0, "withdraw"),
            new(new DateOnly(2024, 7, 25), 0, 0, 0, "nothing"),
        };
